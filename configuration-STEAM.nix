...

{
  ...
  # 32-bit graphics support for Steam (also enabled via pipewire.alsa.support32Bit)
  hardware.graphics.enable32Bit = true;

  # XDG portals for GNOME integration (file pickers, screenshots, etc.)
  xdg.portal = {
    enable = true;
